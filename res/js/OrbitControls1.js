...
THREE.OrbitControls = function ( object, domElement ) {
	...
	this.rotateTarget = new THREE.Vector3(); //the center of object rotate around
    ...
    this.enablaedMoveY = true; //yaojia7
	...
	function handleMouseMoveRotate( event ) {
		...
		if(scope.enablaedMoveY) rotateUp( 2 * Math.PI * rotateDelta.y / element.clientHeight * scope.rotateSpeed );
